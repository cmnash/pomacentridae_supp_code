...
#MuHisse_m13 <- MuHiSSE(phy = pom_benthic$phy, data = state, f = f, turnover = turnover_m13, eps = extinction.fraction_m13, hidden.states = T, trans.rate = trans.rate.mod_m13)


StartingValueTry(phy = pom_benthic$phy, data = state, f = f, trans.rate = trans.rate.mod_m13, tau = turnover_m13, eps = extinction.fraction_m13, hidden = T, name = "Pom_MuHisse_m13")
